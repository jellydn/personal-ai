...
Open the portfolio site. The homepage loads instantly — 41 projects across four
...
- Clear the filter to return to all 41 projects. An empty-state message appears
