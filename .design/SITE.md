...
| **Mission** | Showcase 47 real, runnable, forkable open-source projects built with AI over 10 months, and market the live portfolio tracker |
...
2. **Enhance the core** — support the site mission (47 projects, AI-built, open source)
