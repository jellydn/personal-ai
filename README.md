...
> Public original projects created during the last nine months, built with AI-assisted development.

This collection covers public original repositories created between **October 20, 2025 and July 20, 2026**. Forks and private repositories are excluded.
...
- **Description**: A substantial user-facing application and one of the clearest examples of a complete product built with AI assistance.
- **Approach**: Built as a full web application with AI-assisted development across the product.
- **Demo**: Not ready yet.

### [ai-photo-coach](https://github.com/jellydn/ai-photo-coach)
- **Description**: Analyses photographs and gives coaching or improvement feedback.
- **Approach**: Uses AI-assisted visual critique to turn images into actionable feedback.
- **Demo**: Not ready yet.

### [echo-note](https://github.com/jellydn/echo-note)
- **Description**: Lightweight note-taking application with voice or AI-oriented workflows.
...
- **Approach**: Focuses on a simple educational writing experience built with AI-assisted development.
- **Demo**: Not ready yet.

### [tiny-pomodoro](https://github.com/jellydn/tiny-pomodoro)
- **Description**: Minimal Pomodoro timer application.
- **Approach**: Small productivity app with a focused single-purpose workflow.
- **Demo**: Not ready yet.

### [docklight](https://github.com/jellydn/docklight)
- **Description**: Developer web interface for managing or inspecting Docker-related resources.
- **Approach**: Provides a browser-based workflow for Docker inspection and management.
- **Demo**: Not ready yet.
...
- **Description**: Compares resumes with job descriptions using semantic or AI analysis.
- **Approach**: Uses semantic matching to compare candidate profiles and job requirements.
- **Demo**: https://smart-resume.itman.fyi

### [rag-blog](https://github.com/jellydn/rag-blog)
- **Description**: Retrieval-augmented generation application grounded in blog content.
...
- **Description**: Alerting or monitoring application.
...
- **Description**: Lightweight personal activity tracking application.
...
- **Description**: Portable workspace for AI coding agents, skills, memory and MCP configurations.
...
- **Description**: AI-assisted development and workflow orchestration project.
...
- **Approach**: Provides a lightweight local setup for model testing and iteration.
- **Demo**: Not ready yet.

### [ai-photo-coach](https://github.com/jellydn/ai-photo-coach)
- **Description**: AI-powered photography feedback application.
- **Approach**: AI-assisted critique for photo composition and improvement.
- **Demo**: Not ready yet.

### [ai-smart-gmail](https://github.com/jellydn/ai-smart-gmail)
- **Description**: AI email-management application.
- **Approach**: Uses AI to process, sort and understand incoming email.
- **Demo**: https://jellydn.github.io/ai-smart-gmail/lessons/0001-what-is-an-embedding.html

### [smart-resume-matcher](https://github.com/jellydn/smart-resume-matcher)
- **Description**: AI and semantic resume-matching application.
- **Approach**: Compares resumes and job descriptions using semantic similarity.
- **Demo**: https://smart-resume.itman.fyi

### [rag-blog](https://github.com/jellydn/rag-blog)
- **Description**: Retrieval-augmented generation application over blog content.
- **Approach**: Grounds answers in retrieved blog passages before generation.
- **Demo**: https://jellydn.github.io/rag-blog/
...
- **Approach**: Provides a TUI for editing and organising env data.
- **Demo**: Not ready yet.
...
- **Description**: Experimental or challenge-based development project.
- **Approach**: Exploration-oriented repository used for iterative experimentation.
- **Demo**: Not ready yet.
...
- Some repositories appear in more than one category because they fit multiple portfolio narratives.
- GitHub date-filtered public repository search was used to validate projects in the requested period.
- The list is intentionally focused on public original work.
